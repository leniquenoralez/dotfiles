...
Please see the [extensions documentation](https://github.com/redhat-developer/vscode-xml/blob/master/./docs/Extensions#custom-xml-extensions) for more information.
